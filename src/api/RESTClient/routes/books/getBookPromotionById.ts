...
/**
 * Отримує дані Книги типу Promotion за його ідентифікатором.
 *
...
export async function getBookByIdPromotion(
  this: BaseRESTClient,
  { book_id }: TParams,
  ...
  try {
    const response = await this.client.get<TSuccess>(`/books/promotion/${book_id}/`, {
      ...config,
      signal,
    });
    return {
