...
/**
 * Отримує список усіх Книжок типу Promotion із сервера.
 *
...
export async function getAllBooksPromotions(
  this: BaseRESTClient,
  ...
  try {
    const response = await this.client.get<TSuccess>('/books/promotion', {
      ...config,
      signal,
      params,
      paramsSerializer: {
