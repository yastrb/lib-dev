...
/**
 * Отримує список усіх Книжок типу NewArrival із сервера.
 *
...
export async function getAllBooksNewArrivals(
  this: BaseRESTClient,
  ...
  try {
    const response = await this.client.get<TSuccess>('/books/new', {
      ...config,
      signal,
      params,
      paramsSerializer: {
