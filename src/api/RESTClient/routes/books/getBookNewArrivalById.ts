...
/**
 * Отримує дані Книги типу NewArrival за його ідентифікатором.
 *
...
export async function getBookByIdNewArrival(
  this: BaseRESTClient,
  { book_id }: TParams,
  ...
  try {
    const response = await this.client.get<TSuccess>(`/books/new/${book_id}/`, {
      ...config,
      signal,
    });
    return {
